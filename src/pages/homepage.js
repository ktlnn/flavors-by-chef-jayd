    ...
    <>
      ...
      <div className="about-me">
        ...
        <p id="about-me-body">
          ...
          technique on how it's cooked as a blance of love and risk. It's a risk
          for me if one ingredient is too powerful or the food is over cooked.
          It's love for me when I build my work of art, and the feeling for me
          is as equivalent as a first kiss... as an impactful wind on a rainy
          day... as the scorching air during a heat wave. Yes, it feels to me as
          nature at its most potent yet vulnerable state. A balance of love and
          risk is necessary to build the perfect piece of art, and to create the
          perfect taste. This is how I feel when I build my creation. This is
          the feeling I want to resonate to others when they taste my creation.{" "}
        </p>
        </div>
